...
public class DecksButton {
  private Image image1 = new Image(getClass().getResourceAsStream("decksbuttonup.png"));
  private Image image2 = new Image(getClass().getResourceAsStream("decksbuttondown.png"));
  	
  public DecksButton(Button newButton) {

...
public class HomeButton {
  private Image image1 = new Image(getClass().getResourceAsStream("homebuttonup.png"));
  private Image image2 = new Image(getClass().getResourceAsStream("homebuttondown.png"));
  	
  public HomeButton(Button newButton) {

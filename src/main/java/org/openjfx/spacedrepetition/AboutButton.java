...
public class AboutButton {
  private Image image1 = new Image(getClass().getResourceAsStream("aboutbuttonup.png"));
  private Image image2 = new Image(getClass().getResourceAsStream("aboutbuttondown.png"));
  	
  public AboutButton(Button newButton) {

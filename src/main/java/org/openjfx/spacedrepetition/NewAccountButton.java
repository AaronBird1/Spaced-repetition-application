...
public class NewAccountButton {
  private Image image1 = new Image(getClass().getResourceAsStream("newaccountbuttonup.png"));
  private Image image2 = new Image(getClass().getResourceAsStream("newaccountbuttondown.png"));
  	
  public NewAccountButton(Button newButton) {

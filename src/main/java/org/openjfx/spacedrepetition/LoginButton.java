...
public class LoginButton {
  private Image image1 = new Image(getClass().getResourceAsStream("loginbuttonup.png"));
  private Image image2 = new Image(getClass().getResourceAsStream("loginbuttondown.png"));
  	
  public LoginButton(Button newButton) {

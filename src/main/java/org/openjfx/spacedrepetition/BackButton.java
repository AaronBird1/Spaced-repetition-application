...
public class BackButton {
  private Image image1 = new Image(getClass().getResourceAsStream("backbuttonup.png"));
  private Image image2 = new Image(getClass().getResourceAsStream("backbuttondown.png"));
  	
  public BackButton(Button newButton) {
